...
*
* @package    bright-cloud-studio/gai-invoice
...
class ModTestLateCancelAdditional extends \Contao\Module
{
...
* @var string
*/
protected $strTemplate = 'mod_test_late_cancel_additional';
    ...
    */
    public function generate()
    {
        if (TL_MODE == 'BE')
        {
            ...
            $objTemplate->wildcard = '### ' . utf8_strtoupper($GLOBALS['TL_LANG']['FMD']['test_late_cancel_additional'][0]) . ' ###';
