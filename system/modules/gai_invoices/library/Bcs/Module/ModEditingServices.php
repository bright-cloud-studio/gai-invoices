...
class ModEditingServices extends \Contao\Module
{
...
* @var string
*/
protected $strTemplate = 'mod_editing_services';
    ...
    */
    public function generate()
    {
        if (TL_MODE == 'BE')
        {
            ...
            $objTemplate->wildcard = '### ' . utf8_strtoupper($GLOBALS['TL_LANG']['FMD']['editing_services'][0]) . ' ###';
