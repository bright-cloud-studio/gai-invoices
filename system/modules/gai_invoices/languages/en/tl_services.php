...
$GLOBALS['TL_LANG']['tl_psychologists']['edit']                       = array('Edit record', 'Edit record ID %s');
$GLOBALS['TL_LANG']['tl_psychologists']['copy']                       = array('Copy record', 'Copy record ID %s');
$GLOBALS['TL_LANG']['tl_psychologists']['delete']                     = array('Delete record', 'Delete record ID %s');
$GLOBALS['TL_LANG']['tl_psychologists']['toggle']                     = array('Toggle record', 'Toggle record ID %s');

/* System Fields */
$GLOBALS['TL_LANG']['tl_psychologists']['publish_legend']             = 'Publish';
$GLOBALS['TL_LANG']['tl_psychologists']['alias']                      = array('Alias', 'Auto-generated alias.');
