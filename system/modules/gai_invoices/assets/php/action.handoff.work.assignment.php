<?php
    ...
    if($vars['shared_total'] == 0) { $range = 'SY2022-2023!AB' . $vars['sheet_row']; }
    if($vars['shared_total'] == 1) { $range = 'SY2022-2023!AD' . $vars['sheet_row']; }
    if($vars['shared_total'] == 2) { $range = 'SY2022-2023!AF' . $vars['sheet_row']; }
    if($vars['shared_total'] == 3) { $range = 'SY2022-2023!AH' . $vars['sheet_row']; }
    if($vars['shared_total'] == 4) { $range = 'SY2022-2023!AJ' . $vars['sheet_row']; }
